...
var person = prompt("Please enter github user", "");



var urlRepos = 'https://api.github.com/users/'+person+'/repos',
	urlProfile = 'https://api.github.com/users/'+person
 	params = {
	access_token: token
}
...
var repoDataHandler = function(responseObject){
	console.log(responseObject)
	var htmlCard = '<h1>Respositories</h1>'
